...
| —   | `(agent-registry)` — logical agents over runtimes   | `AgentRegistry` + `Coordinator` harness map                              | n/a (net-new) | ◐ core (runtime-neutral dispatch)     | ☐       |
